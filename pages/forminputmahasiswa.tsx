...
return(
  ...
  return (
    ...
    <br/>
     <Button id="btnadd" onClick={handleAdd} className={`btn btn-success`}><PencilSquare /> Add New</Button>
     <div className="row">
              ...
              {mahasiswa.map((mhs) => (
                <Card>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>
                      <p>Kode: {mhs.nim}</p>
                      <p>Tanggal: {mhs.tanggal_lahir}</p>
                      <p>Alamat: {mhs.alamat}</p> 
                    </Card.Text> <br/>
                    <div className="card-actions">
                      <Button onClick={handleEdit} value={mhs.nim}className={`btn btn-warning`}>
                        <PencilSquare /> Edit
                      </Button>
                      <Button onClick={handleDelete} value={mhs.nim} variant="danger">
                        <Trash /> Delete
